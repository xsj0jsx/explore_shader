...
GLuint show_face_program, show_normal_program;
GLuint vao;
...
void init()
{
	...
	ShaderType_Fname face_shaders = {{GL_VERTEX_SHADER, "face_vertex.shader"}
									 ,{GL_FRAGMENT_SHADER, "fragment.shader"}};
	show_face_program = buildProgrameFromFile(face_shaders);
}
...
void display()
{
	...
	std::vector<GLuint> the_programe{show_face_program, show_normal_program};
